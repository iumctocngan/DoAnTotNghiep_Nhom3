        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LearningNote = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MainTeacherUserId = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AmountDue = table.Column<decimal>(type: "decimal(18,0)", precision: 18, scale: 0, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentRemarks_Enrollments_EnrollmentId",
                        column: x => x.EnrollmentId,
                        principalTable: "Enrollments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StudentRemarks_Sessions_SessionId",
                        column: x => x.SessionId,
                        principalTable: "Sessions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attendances_SessionId_EnrollmentId",
                table: "Attendances",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Classes_MainTeacherUserId",
                table: "Classes",
                column: "MainTeacherUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Lessons_LevelId_Code",
                table: "Lessons",
                columns: new[] { "LevelId", "Code" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Lessons_LevelId_SortOrder",
                table: "Lessons",
                columns: new[] { "LevelId", "SortOrder" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Levels_CourseId_Code",
                table: "Levels",
                columns: new[] { "CourseId", "Code" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Levels_CourseId_SortOrder",
                table: "Levels",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentGuardians_StudentId_IsPrimary",
                table: "StudentGuardians",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentRemarks_EnrollmentId",
                table: "StudentRemarks",
                column: "EnrollmentId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentRemarks_SessionId",
                table: "StudentRemarks",
                column: "SessionId");
